...
function HourlyForcast() {
  ...
  return (
    <div>
      <div className='flex box-border mt-2 mx-auto h-32 w-11/12 bg-black bg-opacity-5 rounded-2xl mb-3'>
      <span className='absolute'><div className='flex pl-4 pt-2 text-xs  text-white text-opacity-70'><Icon name='clock'/><p className='font-medium pl-1'>HOURLY FORCAST</p></div></span>
        ...
        <div id='HourBox' className="text-white mt-6 grid grid-flow-col auto-cols-max gap-8 pl-4 overflow-x-auto pr-5">
          ...
          <div id='div1' className='flex flex-col justify-center items-center'>
            <span className='text-xs mb-2'><h1 id='1'>{x[0]}</h1></span>
            <Icon name='cloud'/>               
            <p className='text-base mt-2'>
            <span className='flex'>
          ...
          <div id='div2' className='flex flex-col justify-center items-center'>
            <span className='text-xs mb-2'><h1 id='2'>{x[1]}</h1></span>
            <Icon name='moon' />               
            <p className='text-base mt-2'>
            <span className='flex'>
          ...
          <div id='div3' className='flex flex-col justify-center items-center'>
            <span className='text-xs mb-2'><h1 id='3'>{x[2]}</h1></span>
          ...
          <div id='div4' className='flex flex-col justify-center items-center'>
            <span className='text-xs mb-2'><h1 id='4' >{x[3]}</h1></span>
          ...
          <div id='div5' className='flex flex-col justify-center items-center'>
            <span className='text-xs mb-2'><h1 id='5' >{x[4]}</h1></span>
          ...
          <div id='div6' className='flex flex-col justify-center items-center'>
            <span className='text-xs mb-2'><h1 id='6' >{x[5]}</h1></span>
          ...
          <div id='div7' className='flex flex-col justify-center items-center'>
            <span className='text-xs mb-2'><h1 id='7' >{x[6]}</h1></span>
          ...
          <div id='div8' className='flex flex-col justify-center items-center'>
            <span className='text-xs mb-2'><h1 id='8' >{x[7]}</h1></span>
          ...
          <div id='div9' className='flex flex-col justify-center items-center'>
            <span className='text-xs mb-2'><h1 id='9' >{x[8]}</h1></span>
          ...
          <div id='div10' className='flex flex-col justify-center items-center'>
            <span className='text-xs mb-2'><h1 id='10' >{x[9]}</h1></span>
          ...
          <div id='div11' className='flex flex-col justify-center items-center'>
            <span className='text-xs mb-2'><h1 id='11' >{x[10]}</h1></span>
          ...
          <div id='div12' className='flex flex-col justify-center items-center'>
            <span className='text-xs mb-2'><h1 id='12' >{x[11]}</h1></span>
            <Icon name='wind' />             
            <p className='text-base mt-2'>
            <span className='flex'>
          ...
          <div id='div13' className='flex flex-col justify-center items-center'>
            <span className='text-xs mb-2'><h1 id='13' >{x[12]}</h1></span>
            <Icon name='sun' />              
            <p className='text-base mt-2'>
            <span className='flex'>
          ...
          <div id='div14' className='flex flex-col justify-center items-center'>
            <span className='text-xs mb-2'><h1 id='14' >{x[13]}</h1></span>
            <Icon name='sun' />              
            <p className='text-base mt-2'>
            <span className='flex'>
          ...
          <div id='div15' className='flex flex-col justify-center items-center'>
            <span className='text-xs mb-2'><h1 id='15' >{x[14]}</h1></span>
            <Icon name='snowflake'/>         
            <p className='text-base mt-2'>
            <span className='flex'>
          ...
          <div id='div16' className='flex flex-col justify-center items-center'>
            <span className='text-xs mb-2'><h1 id='16' >{x[15]}</h1></span>
            <Icon name='sun' />              
            <p className='text-base mt-2'>
            <span className='flex'>
          ...
          <div id='div17' className='flex flex-col justify-center items-center'>
            <span className='text-xs mb-2'><h1 id='17' >{x[16]}</h1></span>
            <Icon name='sun' />              
            <p className='text-base mt-2'>
            <span className='flex'>
          ...
          <div id='div18' className='flex flex-col justify-center items-center'>
            <span className='text-xs mb-2'><h1 id='18' >{x[17]}</h1></span>
            <Icon name='sun' />              
            <p className='text-base mt-2'>
            <span className='flex'>
          ...
          <div id='div19' className='flex flex-col justify-center items-center'>
            <span className='text-xs mb-2'><h1 id='19' >{x[18]}</h1></span>
            <Icon name='sun' />              
            <p className='text-base mt-2'>
            <span className='flex'>
          ...
          <div id='div20' className='flex flex-col justify-center items-center'>
            <span className='text-xs mb-2'><h1 id='20' >{x[19]}</h1></span>
            <Icon name='sun' />              
            <p className='text-base mt-2'>
            <span className='flex'>
          ...
          <div id='div21' className='flex flex-col justify-center items-center'>
            <span className='text-xs mb-2'><h1 id='21' >{x[20]}</h1></span>
            <Icon name='sun' />              
            <p className='text-base mt-2'>
            <span className='flex'>
          ...
          <div id='div22' className='flex flex-col justify-center items-center'>
            <span className='text-xs mb-2'><h1 id='22' >{x[21]}</h1></span>
            <Icon name='sun' />              
            <p className='text-base mt-2'>
            <span className='flex'>
          ...
          <div id='div23' className='flex flex-col justify-center items-center'>
            <span className='text-xs mb-2'><h1 id='23' >{x[22]}</h1></span>
            <Icon name='sun' />              
            <p className='text-base mt-2'>
            <span className='flex'>
          ...
          <div id='div24' className='flex flex-col justify-center items-center'>
            <span className='text-xs mb-2'><h1 id='24' >{x[23]}</h1></span>
            <Icon name='sun' />              
            <p className='text-base mt-2'>
            <span className='flex'>
          ...
          <div id='sunrise' className='flex flex-col justify-center items-center'>
            <h1 className='text-xs mb-2'>{sunrise}</h1>
            <Icon name='sunrise' />    
            <p className='text-base mt-2'>
            <span className='flex'>
          ...
          <div id='sunset' className='flex flex-col justify-center items-center'>
            <h1 className='text-xs mb-2'>{sunset}</h1>
            <Icon name='sunset' />       
            <p className='text-base mt-2'>
            <span className='flex'>
